...
// Missing the animation only

export default function Exp({setShowExp}){
  return (
    <Modal setShowModal={setShowExp}>
        <section className="w-full max-w-3xl mx-auto px-4 text-zinc-100">
                        ...
                        <li key={item.id} className="relative flex gap-6 md:gap-10 opacity-0 animate-fadeInFromUp" style={{ animationDelay: `${idx * 250}ms` }}>
                            ...
                            >
                                <header className="mb-2">
                                    <div className={`flex justify-between align-middle mb-1 pl-8 ${
                                        isLeft
                                ...
                                <ul
                                    className={`list-disc text-right ${
                                    isLeft 
